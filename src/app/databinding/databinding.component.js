...
var DatabindingComponent = (function () {
    function DatabindingComponent() {
        this.stringInterpolationForPropertyBinding = 'String bound to DOM value property';
        this.stringInterpolation = 'The next output is number interpolation!';
        this.numberInterpolation = 2;
    }
    DatabindingComponent.prototype.onTest = function () {
        return true;
    };
    DatabindingComponent.prototype.onBlitzen = function (value) {
        alert(value);
    };
